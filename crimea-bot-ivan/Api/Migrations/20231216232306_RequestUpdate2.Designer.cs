...
namespace Api.Migrations
{
    ...
    [Migration("20231216232306_RequestUpdate2")]
            ...
            modelBuilder.Entity("Api.Models.Entities.BotThemeEntity", b =>
                {
                    ...
                    b.Property<string>("ThemeExecutor")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Api.Models.Entities.LocalizebleResource", b =>
                {
                    ...
                    b.Property<Guid?>("ReplyKeyboardButtonEntityId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReplyKeyboardButtonEntityId");
            ...
            modelBuilder.Entity("Api.Models.Entities.ReplyKeyboardButtonEntity", b =>
                {
                    ...
                    b.Property<Guid?>("BotThemeToNavigateId")
                        .HasColumnType("uuid");

                    b.Property<string>("CallbackValue")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("BotThemeToNavigateId");

                    b.ToTable("ReplyKeyboardButtons");
                });

            modelBuilder.Entity("Api.Models.Entities.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("Criminal")
                        .HasColumnType("boolean");

                    b.Property<bool>("ExpungedCriminal")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Api.Models.Entities.LocalizebleResource", b =>
                {
                    ...
                    b.HasOne("Api.Models.Entities.ReplyKeyboardButtonEntity", null)
                        .WithMany("LocalizedTexts")
                        .HasForeignKey("ReplyKeyboardButtonEntityId");
            ...
            modelBuilder.Entity("Api.Models.Entities.ReplyKeyboardButtonEntity", b =>
                {
                    ...
                    b.HasOne("Api.Models.Entities.BotThemeEntity", "BotThemeToNavigate")
                        .WithMany()
                        .HasForeignKey("BotThemeToNavigateId");

                    b.Navigation("BotThemeToNavigate");
                });
